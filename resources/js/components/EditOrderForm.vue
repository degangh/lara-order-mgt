...
<v-card>
        <v-toolbar dark color="primary">
          ...
          <v-toolbar-title>Edit Order</v-toolbar-title>
          <v-spacer></v-spacer>
          <v-btn icon dark @click="emitCloseDialog('editOrderDialog')">
            <v-icon>close</v-icon>
          </v-btn>
        </v-toolbar>
    ...
    <v-stepper-items>
      ...
      <v-stepper-content step="3">
        ...
        <v-card-actions>
          ...
          <v-spacer></v-spacer>
          <v-btn flat  @click="emitCloseDialog('editOrderDialog')">Cancel</v-btn>
